...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-lg bg-surface-2 p-1 text-text-secondary',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-bg-primary data-[state=active]:text-neon-cyan data-[state=active]:shadow-sm',
      className
    )}
    {...props}
  />
