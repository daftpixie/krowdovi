  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        {
          'border-white/10 bg-surface-1 text-text-primary': variant === 'default',
          'border-red-500/50 bg-red-500/10 text-red-400': variant === 'destructive',
          'border-neon-green/50 bg-neon-green/10 text-neon-green': variant === 'success',
        },
        className
      )}
      {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      'inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-white/10 bg-transparent px-3 text-sm font-medium transition-colors hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-neon-cyan disabled:pointer-events-none disabled:opacity-50',
      className
    )}
    {...props}
  />
